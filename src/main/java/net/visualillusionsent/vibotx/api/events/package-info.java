 ...
 * Event API Package
 * <p/>
 * Contains the necessary classes to pass events to {@link net.visualillusionsent.vibotx.api.plugin.Plugin}'s
 * <p/>
 * Some source code in this package is derived and adapted from CanaryLib
